...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@frankwei98/unisave-sdk-oktest'
...
const ETHERSCAN_PREFIXES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.OKCHAIN_TEST]: 'www.oklink.com/okexchain-test',
