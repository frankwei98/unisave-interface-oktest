...
import { JSBI, TokenAmount, ETHER } from '@frankwei98/unisave-sdk-oktest'
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>{t('step-1-get-scam-v2-liquidity-tokens')}</TYPE.white>
              </RowBetween>
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        <BottomSection gap="lg" justify="center">
          ...
          <StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
            ...
            <AutoColumn gap="sm">
              <RowBetween>
                <div>
                  <TYPE.black>{t('yourUnclaimedScam')}</TYPE.black>
                </div>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          {t('when-you-withdraw-the-contract-will-automagically-claim-scam-on-your-behalf')}
        </TYPE.main>

        {!showAddLiquidityButton && (
          <DataRow style={{ marginBottom: '1rem' }}>
            <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
              {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? t('deposit') : t('deposit-scam-v2-lp-tokens')}
            </ButtonPrimary>
